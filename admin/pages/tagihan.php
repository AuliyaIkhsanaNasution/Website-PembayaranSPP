...
// Query to fetch data from the tagihan table along with related tables
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="mb-5">
          <a href="functions/tambahkamar.php" class="p-3 rounded-2 bg-gradient-primary text-white text-bold">Tambah Tagihan</a>
        </div>
        <div class="col-12">
          <div class="card my-4">
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <?php
                    $nom = 1;
                    while ($tagihan = $hasil->fetch_assoc()) :
                    ?>
                      <tr>
                        <td class="text-center"><?= $nom++ ?></td>
                        <td class="align-middle text-center text-sm"><?= $tagihan['nisn'] ?></td>
                        <td class="align-middle text-center text-sm"><?= $tagihan['nama'] ?></td>
                        <td class="align-middle text-center text-sm"><?= $tagihan['nama_kelas'] ?></td>
                        <td class="align-middle text-center text-sm"><?= $tagihan['nama_bulan'] ?></td>
  ...
  <!-- Main modal -->
  <div id="tagihan" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
          ...
          <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="tagihan">
