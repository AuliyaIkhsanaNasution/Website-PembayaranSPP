...
if (isset($_POST["submit"])) {
    ...
    if ($conn->query($query) === TRUE) {
        header("location: ../kelas.php?tambah=true");
    } else {
    ...
    <div class="container  bg-white  rounded-3 my-7 m-auto w-60">
        <div class="card card-plain">
            <div class="card-header pb-0 text-start">
                <h4 class="font-weight-bolder text-5xl text-primary text-center">Tambah Data Kelas</h4>
            </div>
            ...
            <div class="card-body">
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_kelas" style="border: 2px solid gray;" class="form-control form-control-lg" placeholder="Nama Kelas" required>
                    </div>

                    <div class="text-center">
                        <button type="submit" name="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Tambahkan Data</button>
                    </div>
                    <p class="text-sm mt-3 mb-0">Tidak ingin menambahkan kelas? <a href="../kelas.php" class="text-dark font-weight-bolder">kembali</a></p>
                </form>
            </div>
        </div>
    </div>
