...
<html lang="en" class="scroll-smooth">
 ...
 Website Smart School
    ...
    <nav id="header" class="fixed w-full z-30 top-0 text-white">
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        <div class="pl-4 flex items-center">
          ...
          <svg class="w-10 h-10 text-gray-800 dark:text-white mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="none" viewBox="0 0 24 24">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            ...
            <li class="mr-3">
              <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#gallery">Gallery</a>
            </li>
          </ul>
    ...
    <div class="pt-24" id="home">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full">Kamu penasaran dengan Smart School?</p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
            Selamat Datang Di Smart School!
          </h1>
          <p class="leading-normal text-2xl mb-8">
            Salah Satu Sekolah Terbaik Yang Ada Di Medan!
          </p>
          <a href="siswa/login.php" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
            Login Siswa
          </a>
        </div>
        <!--Right Col-->
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
              Apa itu smart school?
            </h3>
            <p class="text-gray-600 mb-8">
              Smart School adalah sekolah yang terkenal dengan keunggulannya dalam menghasilkan siswa-siswa berprestasi yang unggul di berbagai bidang akademik dan non-akademik. Berkat dedikasi guru-guru yang profesional dan berpengalaman, serta pendekatan pembelajaran yang inovatif dan berpusat pada siswa, kami mampu menciptakan lingkungan pendidikan yang mendorong setiap siswa untuk mencapai potensi maksimal mereka. Melalui program-program ekstrakurikuler yang beragam dan kompetisi-kompetisi yang menantang, siswa kami terus mengasah kemampuan mereka dan membuktikan keunggulannya di tingkat lokal, nasional, maupun internasional. Selain itu, dukungan penuh dari staf dan fasilitas sekolah yang lengkap turut membantu menciptakan suasana belajar yang kondusif dan menyenangkan.
              <br />
              <br />
            </p>
          </div>
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                Dimana Lokasi Smart School
              </h3>
              <p class="text-gray-600 mb-8">
                Smart School, yang terletak di lokasi strategis di Jl. Pertahanan No.99, Sigara Gara, Kec. Patumbak, Kabupaten Deli Serdang, Sumatera Utara 20361, menawarkan akses yang mudah bagi siswa dari berbagai wilayah. Keunggulan lokasinya tidak hanya memudahkan transportasi tetapi juga menciptakan lingkungan belajar yang tenang dan kondusif. Berada di pusat kawasan pendidikan, Smart School dikelilingi oleh berbagai fasilitas penunjang yang mendukung proses belajar mengajar, menjadikannya pilihan ideal bagi para orang tua yang menginginkan pendidikan berkualitas bagi anak-anak mereka. Lokasi ini memastikan bahwa siswa dapat menikmati akses mudah ke berbagai sumber daya dan kegiatan ekstrakurikuler yang memperkaya pengalaman belajar mereka.
                <br />
                <br />
              </p>
            </div>
  ...
  <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-white">
    Gallery Smart School
  </h1>
  <div class="grid grid-cols-2 gap-2 mb-8">
    <div>
      <img class="w-full h-full object-cover rounded-lg" src="assets/img/gambar5.jpg" alt="">
    </div>
    <div>
      <img class="w-full h-full object-cover rounded-lg" src="assets/img/gambar2.jpg" alt="">
    </div>
    <div>
      <img class="w-full h-full object-cover rounded-lg" src="assets/img/gambar3.jpg" alt="">
    </div>
    <div>
      <img class="w-full h-full object-cover rounded-lg" src="assets/img/gambar4.jpg" alt="">
    </div>
  </div>
</section>
        ...
        <div class="w-full flex flex-col md:flex-row py-6">
          <div class="flex-1 mb-6 text-black">
            <a class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl flex items-center" href="#">
              ...
              <span class="text-white">SMART SCHOOL</span>
            </a>
          </div>
          <div class="flex-1 ">
            <p class="uppercase text-gray-500 md:mb-6 text-white">Links</p>
            <ul class="list-reset mb-6">
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500 text-white">FAQ</a>
              </li>
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500 text-white">Help</a>
              </li>
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500 text-white">Support</a>
              </li>
            </ul>
          </div>
          <div class="flex-1">
            <p class="uppercase text-gray-500 md:mb-6 text-white">Legal</p>
            <ul class="list-reset mb-6">
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500 text-white">Terms</a>
              </li>
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500 text-white">Privacy</a>
              </li>
            </ul>
          </div>
          <div class="flex-1">
            <p class="uppercase text-gray-500 md:mb-6 text-white">Social</p>
            <ul class="list-reset mb-6">
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="admin/login.php" class="no-underline hover:underline text-gray-800 hover:text-pink-500 text-white">Admin</a>
              </li>
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500 text-white">Linkedin</a>
              </li>
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500 text-white">Twitter</a>
              </li>
            </ul>
          </div>
          <div class="flex-1">
            <p class="uppercase text-gray-500 md:mb-6 text-white">Company</p>
            <ul class="list-reset mb-6">
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500 text-white">Official Blog</a>
              </li>
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500 text-white">About Us</a>
              </li>
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500 text-white">Contact</a>
              </li>
            </ul>
          </div>
        </div>
